...
+--public/    
 ...
 |-- book_placeholder.gif - Book placeholder image for cases when there's no image returned from the Book API
+-- src/
 ...
 |-- Book.js - React component to draw a single book
 |-- BooksAPI.js - A JavaScript API for the provided Udacity backend. 
 Instructions for the methods are below.
 |-- index.js - You should not need to modify this file. It is used for DOM rendering only.
 |-- index.css - Global styles. You probably won't need to change anything here.
 |-- ListBooks.js - React component to draw all the shelves of the App
 |-- ListShelf.js - React component to draw a single shelf
 |-- SearchBooks.js - React component to draw the page for searching
|-- .gitignore 
